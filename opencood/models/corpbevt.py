...
from opencood.models.backbones.repvgg_encoder import RepVGGEncoder
...
class CorpBEVT(nn.Module):
    def __init__(self, config):
        ...
        self.encoder = RepVGGEncoder(config['encoder'])
    ...
    def forward(self, batch_dict):
        ...
        #result = [self.encoder(x[i,:,:,:,:,:].unsqueeze(0)) for i in range(b)]
