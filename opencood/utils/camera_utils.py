...
def project_3d_to_camera(objects, intrinsic, extrinsic):
    ...
    for i in range(objects.shape[0]):
        ...
        # object_in_camera = np.array([
        #     object_in_camera[1] * -1,
        #     object_in_camera[2],
        #     object_in_camera[0]])
...
def plot_all_agents(draw_image_list, cav_id, draw_root):
    """
    ...
    """
    fig, axarr = plt.subplots(len(draw_image_list), 1)
